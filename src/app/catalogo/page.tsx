...
export const metadata: Metadata = {
  title: "Catálogo",
  description: "Catálogo de consolas, controles y juegos de T.PlayGames.",
};
...
export default async function CatalogPage({
  ...
  const query: CatalogQuery = {
    ...
    available: stringParam(params.available) === "true",
...
function parseType(value: string | string[] | undefined): CatalogQuery["type"] {
...
function parseSort(value: string | string[] | undefined): CatalogQuery["sort"] {
  const raw = stringParam(value);
  if (
    raw === "price_asc" ||
    raw === "price_desc" ||
